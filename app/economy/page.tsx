  ...
  return (
    <main className={styles.main}>
      <section className={styles.section}> {/* Main content section */}
        <h1 className={styles.title}>The HODLOTTO Economy</h1>
        <p className={styles.description} style={{ marginBottom: '2rem' }}>
          Understanding HODLOTTO's unique economic model balancing growth, participation, and long-term rewards through utility and strategic holding.
        </p>
        ...
        <article className={styles.contentArticle}>
          ...
          {/* --- TABLE START --- */}
          <div className={styles.tableContainer}> {/* Optional: Add a container for overflow */}
